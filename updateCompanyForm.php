...
<section class="updateCompanyPage">
    ...
    <form class="updateCompanyForm" action="company.php" method="post">
        ...
        <div class= "col-25">
        <input class="inputfill" type="text" value="<?php echo $comRow['Company_Code'] ?>" name="companyCode" id="companyCode" disabled required>
        </div>
        <div class= "col-25">
        ...
        ?>
            <option value="<?php echo $adminRow['Category_Id'] ?>" <?php echo $selected ?>><?php echo $adminRow['Category_Name'] ?></option>
        <?php
            }
        }
        ?>
    ...
    <div class= "col-25">
        <input type="text" class="inputfill"  value="<?php echo $comRow['Company_Name'] ?>" name="companyName" id="companyName" required>
    </div>
    <div class= "col-25">
        <label class="labelfill" for="companyContact">Contact No.</label>
    </div>
    <div class= "col-25">
        <input class="inputfill" type="tel"  value="<?php echo $comRow['Company_Phone'] ?>" name="companyContact" id="companyContact" required>
    </div>
        </div>
        <div class="row3">
            <div class="col-25">
        ...
        <div class="col-25">
        <input class="inputfill" type="email"  value="<?php echo $comRow['Company_Email'] ?>" name="companyEmail" id="companyEmail" required>
    </div>
    <div class="col-25">
        <label class="labelfill" for="companyAddress">Address</label>
    </div>
    <div class="col-25">
        <input class="inputfill" type="text"  value="<?php echo $comRow['Company_Address'] ?>" name="companyAddress" id="companyAddress" required>
    </div>
        </div>
        <div class="row3">
        <div class="col-25">
    ...
    <div class="col-25">
        <input class="inputfill" type="text"  value="<?php echo $comRow['Company_Username'] ?>" name="companyUsername" id="companyUsername" required>
    </div>
    <div class="col-25">
        <label class="labelfill" for="companyPassword">Password</label>
    </div>
    <div class="col-25">
        <input class="inputfill" type="text"  value="<?php echo $comRow['Company_Password'] ?>" name="companyPassword" id="companyPassword" required>
    </div>
        </div>
        <div class="row3">
        <div class="col-25">
    ...
    <div class="col-25">
        <input class="inputfill" type="text"  value="<?php echo $comRow['Company_GST'] ?>" name="companyGst" id="companyGst">
    </div>
    <div class="col-25">
        <label class="labelfill" for="companyPan">PAN Number</label>
    </div>
    <div class="col-25">
        <input class="inputfill" type="text"  value="<?php echo $comRow['Company_PAN'] ?>" name="companyPan" id="companyPan">
    </div>
        </div>
        <div class="row3">
        <div class="col-25">
    ...
    <div class="col-25">
        <input class="inputfill" type="text"  value="<?php echo $comRow['Company_TAN'] ?>" name="companyTan" id="companyTan">
    </div>
    <div class="col-25">
        <label class="labelfill" for="companyLicence">Licence Number</label>
    </div>
    <div class="col-25">
        <input class="inputfill" type="text"  value="<?php echo $comRow['Company_Licence'] ?>" name="companyLicence" id="companyLicence">
    </div>
        </div>
        <div class="row4">
